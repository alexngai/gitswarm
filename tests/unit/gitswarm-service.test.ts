...
describe('GitSwarmService', () => {
  let service: InstanceType<typeof GitSwarmService>;
  let mockQuery: ReturnType<typeof vi.fn>;
  let mockGithubApp: { getInstallationToken: ReturnType<typeof vi.fn> };
  ...
  beforeEach(() => {
    ...
    service = new GitSwarmService({ query: mockQuery } as any);
