...
import { Users, MessageSquare, GitPullRequest, Lightbulb, TrendingUp, TrendingDown, Activity, PieChart as PieChartIcon, type LucideIcon } from 'lucide-react';
...
const activityBreakdown: BreakdownEntry[] = [
...
function StatCard({ icon: Icon, label, value, change, up }: StatCardProps): JSX.Element {
  return (
    <Card className="p-4">
...
function CustomTooltip({ active, payload, label, isDark }: CustomTooltipProps): JSX.Element | null {
