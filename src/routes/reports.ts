...
export async function reportRoutes(app: FastifyInstance, options: Record<string, any> = {}): Promise<void> {
  ...
  app.post('/reports', {
    ...
    const { target_type, target_id, reason, description } = (request.body as any);
