 ...
 */
export async function packageRoutes(app: FastifyInstance, options: Record<string, any> = {}): Promise<void> {
  ...
  app.get('/gitswarm/packages', {
    ...
    const { type, repo_id, q, limit, offset } = (request.query as any);
  ...
  app.get('/gitswarm/packages/:type/:name', {
    ...
    const { type, name } = (request.params as any);
  ...
  app.get('/gitswarm/packages/:type/:name/versions', {
    ...
    const { type, name } = (request.params as any);
    const { include_yanked } = (request.query as any);
  ...
  app.get('/gitswarm/packages/:type/:name/versions/:version', {
    ...
    const { type, name, version } = (request.params as any);
  ...
  app.post('/gitswarm/packages/:type/:name/maintainers', {
    ...
    const { type, name } = (request.params as any);
    const { agent_id, role = 'maintainer', can_publish = true, can_yank = false } = (request.body as any);
  ...
  app.delete('/gitswarm/packages/:type/:name/maintainers/:agentId', {
    ...
    const { type, name, agentId } = (request.params as any);
  ...
  app.post('/gitswarm/packages/:type/:name/advisories', {
    ...
    const advisory = await packageRegistry.createAdvisory(pkg.id, (request.body as any), request.agent.id);
  ...
  app.post('/gitswarm/packages/:type/:name/deprecate', {
    ...
    const { type, name } = (request.params as any);
    const { message, alternative } = (request.body as any) || {};
