...
export async function councilRoutes(app, options = {}) {
  ...
  app.post('/gitswarm/repos/:repoId/council', {
    ...
    try {
      const council = await councilCommands.createCouncil(repoId, request.body);
  ...
  app.get('/gitswarm/repos/:repoId/council/eligibility', {
    ...
    const { repoId } = request.params;
    const agentId = request.query.agent_id || request.agent.id;
  ...
  app.post('/gitswarm/repos/:repoId/council/members', {
    ...
    const { repoId } = request.params;
    const targetAgentId = request.body.agent_id || request.agent.id;
  ...
  app.delete('/gitswarm/repos/:repoId/council/members/:agentId', {
    ...
    const { repoId, agentId } = request.params;
  ...
  app.get('/gitswarm/repos/:repoId/council/proposals/:proposalId', {
    ...
    const { repoId, proposalId } = request.params;
  ...
  app.post('/gitswarm/repos/:repoId/council/elections', {
    ...
    try {
      const election = await councilCommands.startElection(council.id, request.agent.id, request.body);
  ...
  app.post('/gitswarm/repos/:repoId/council/elections/:electionId/nominate', {
    ...
    const { repoId, electionId } = request.params;
    const { agent_id, statement } = request.body;
